...
const SignIn = () => {
  ...
  return (
    <div >
      <Navbar/>
      <div className='flex justify-center items-center h-[90.5vh]'>{
...
<div className="form-container rotate-6 sign-in">
    <form action="#">
        <center><h2 className='text-[3rem] text-[aliceblue]'>Login</h2>
        <div className="form-group">
            ...
            <div className="link"> <p>&copy; 2024 LOG-EYE . All Rights Reserved.</p></div></center>
...
<div className="form-container sign-up ">
    <form action="#">
        <center><h2 className='mt-[30px]'>Sign-Up</h2>
        <div className="form-group">
            <input type="text" required/>
